...
import static seedu.address.logic.commands.CommandTestUtil.REMOVE_TAG_DESC_MODULE;
...
public class EditContactCommandParserTest {
    ...
    private static final String TAG_EMPTY = " " + PREFIX_REMOVE_TAG + ALL_TAGS_IDENTIFIER;
    ...
    public void parse_allFieldsSpecified_success() {
        ...
        String userInput = targetIndex.getOneBased() + PHONE_DESC_BOB + TAG_DESC_HUSBAND
                ...
                + REMOVE_TAG_DESC_FRIEND + REMOVE_TAG_DESC_MODULE;

        EditPersonDescriptor descriptor = new EditPersonDescriptorBuilder().withName(VALID_NAME_AMY)
                .withPhone(VALID_PHONE_BOB).withEmail(VALID_EMAIL_AMY).withAddress(VALID_ADDRESS_AMY)
                .withTagsToAdd(VALID_TAG_HUSBAND, VALID_TAG_FRIEND)
                .withTagsToRemove(VALID_TAG_FRIEND, VALID_TAG_MODULE).build();
    ...
    public void parse_oneFieldSpecified_success() {
        ...
        descriptor = new EditPersonDescriptorBuilder().withTagsToAdd(VALID_TAG_FRIEND).build();
        expectedCommand = new EditContactCommand(targetIndex, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);

        // tags to remove
        userInput = targetIndex.getOneBased() + REMOVE_TAG_DESC_FRIEND;
        descriptor = new EditPersonDescriptorBuilder().withTagsToRemove(VALID_TAG_FRIEND).build();
        expectedCommand = new EditContactCommand(targetIndex, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);
    }
    ...
    public void parse_multipleRepeatedFields_acceptsLast() {
        ...
        String userInput = targetIndex.getOneBased() + PHONE_DESC_AMY + ADDRESS_DESC_AMY + EMAIL_DESC_AMY
                ...
                + REMOVE_TAG_DESC_MODULE + REMOVE_TAG_DESC_FRIEND + REMOVE_TAG_DESC_MODULE;

        EditPersonDescriptor descriptor = new EditPersonDescriptorBuilder().withPhone(VALID_PHONE_BOB)
                .withEmail(VALID_EMAIL_BOB).withAddress(VALID_ADDRESS_BOB)
                .withTagsToAdd(VALID_TAG_FRIEND, VALID_TAG_HUSBAND)
                .withTagsToRemove(VALID_TAG_MODULE, VALID_TAG_FRIEND).build();
        EditContactCommand expectedCommand = new EditContactCommand(targetIndex, descriptor);
    ...
    public void parse_resetTags_success() {
        ...
        EditPersonDescriptor descriptor = new EditPersonDescriptorBuilder()
                .withTagsToRemove(ALL_TAGS_IDENTIFIER).build();
        EditContactCommand expectedCommand = new EditContactCommand(targetIndex, descriptor);
